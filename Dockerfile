...
COPY atlassian-extras-decoder-v2-3.4.1.jar ${CONF_INSTALL}/confluence/WEB-INF/lib/atlassian-extras-decoder-v2-3.4.1.jar
...
COPY atlassian-universal-plugin-manager-plugin-2.22.10.jar ${CONF_INSTALL}/confluence/WEB-INF/atlassian-bundled-plugins/atlassian-universal-plugin-manager-plugin-2.22.10.jar
